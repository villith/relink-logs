...
const NET_ENTITY_MAP_BUCKETS_RVA: usize = 0x7bc5018; // 2.0.3: 0x7bc3d98
const NET_ENTITY_MAP_SENTINEL_RVA: usize = 0x7bc5008; // 2.0.3: 0x7bc3d88
const NET_ENTITY_MAP_MASK_RVA: usize = 0x7bc5030; // 2.0.3: 0x7bc3db0
