...
const SBA_SLOT_HANDLES_RVA: usize = 0x7034a40; // 2.0.3: 0x70337b0
const SBA_SLOT_HANDLE_STRIDE: usize = 0x18;
const ENTITY_TABLE_RVA: usize = 0x701f728; // 2.0.3: 0x701e4a8
const SBA_COMPONENT_TYPE_RVA: usize = 0x7ab2190; // 2.0.3: 0x7ab0f10
...
#[cfg(feature = "hookdiag")]
const SESSION_MODE_PTR_RVA: usize = 0x7c52a50; // 2.0.3: 0x7c517d0
