...
/** The tools in the side menu. `newId` keys into NEW_FEATURES. */
const TOOLS = [
  {
  ...
  return (
    <Flex gap="md" align="flex-start">
      <Box w={collapsed ? 56 : 300} style={{ flexShrink: 0 }}>
        {TOOLS.map(({ to, labelKey, labelFallback, icon: Icon, newId }) => {
          ...
          return (
            <NavLink
              ...
              leftSection={
                <Indicator color={NEW_CHIP_COLOR} size={8} offset={1} disabled={!collapsed || !isNew(newId)}>
