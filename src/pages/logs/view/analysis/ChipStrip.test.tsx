...
describe("ChipStrip", () => {
  ...
  it("draws a figure only where the chip has one", () => {
    ...
    const figures = container.querySelectorAll(".analysis-aura-chip-uptime");
  ...
  it("draws a zero figure rather than treating it as absent", () => {
    ...
    expect(container.querySelector(".analysis-aura-chip-uptime")?.textContent).toBe("0%");
  });
  ...
  it("renders the leading node ahead of the label", () => {
    ...
    expect(container.querySelector(".analysis-aura-chip-button > .swatch")).toBeTruthy();
  });
