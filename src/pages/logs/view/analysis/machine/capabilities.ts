...
const RATE_CHART = (series: ChartDecl["series"]): ChartDecl => ({
  series,
  smoothing: "rate",
  scale: 1,
  format: "amount",
...
export const CAPABILITIES: Record<MetricKey, MetricCapabilities> = {
  ...
  sba: {
    ...
    chart: { series: "sba", smoothing: "none", scale: 0.1, format: "percent" },
